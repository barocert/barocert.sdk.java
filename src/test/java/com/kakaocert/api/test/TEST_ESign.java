...
public class TEST_ESign {
	...
	public void getESignState_TEST() throws BarocertException {
		try {
			ESignStateResult result = kakaocertService.getESignState("023030000003", "02303270230300000030000000000032");
	...
	public void getMultiESignState_TEST() throws BarocertException {
		try {
			MultiESignStateResult result = kakaocertService.getMultiESignState("023030000003", "02303270230300000030000000000032");
	...
	public void eSignVerify_TEST() throws BarocertException {
		try {
			...
			ESignVerifyResult result = kakaocertService.eSignVerify("023030000003", "02303270230300000030000000000031");
	...
	public void multiESignVerify_TEST() throws BarocertException {
		try {
			// 검증하기 API는 완료된 전자서명 요청당 1회만 요청 가능하며,
			// 사용자가 서명을 완료하고, 10분(유효시간) 까지 검증하기 API 요청가능 합니다.
			MultiESignVerifyResult result = kakaocertService.multiESignVerify("023030000003", "02303270230300000030000000000032");
