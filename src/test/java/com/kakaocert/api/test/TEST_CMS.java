...
public class TEST_CMS {
	...
	public void getCMSState_TEST() throws BarocertException {
		try {
			CMSStateResult result = kakaocertService.getCMSState("023030000003", "02303270230300000030000000000010");
	...
	public void cMSVerify_TEST() throws BarocertException {
		try {
			...
			CMSVerifyResult result = kakaocertService.cMSVerify("023030000003", "02303270230300000030000000000010");
